...
def buffer_with_count(count, iterable):
    """
        ...
        from: https://stackoverflow.com/questions/8991506/iterate-an-iterator-by-chunks-of-n-in-python # pylint: disable=C0301
    """
        ...
        for pathname_part in pathname.split(os.path.sep):
            ...
            #   * Under some edge-case OSes (e.g., SunOS, *BSD), "ERANGE".
                ...
                if hasattr(exc, 'winerror'):
                    if exc.winerror == ERROR_INVALID_NAME: # pylint: disable=E1101
                        return False
